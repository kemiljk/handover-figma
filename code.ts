...
function makeSelection() {
  ...
  if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'TEXT') {
    ...
    var textSelectionStroke = (figma.currentPage.selection[0] as TextNode).strokeWeight;
  ...
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'RECTANGLE') {
    ...
    var rectSelectionRadius = (figma.currentPage.selection[0] as RectangleNode).cornerRadius;
    figma.ui.postMessage({ "cornerRadius": rectSelectionRadius });
    var rectangleSelectionStroke = (figma.currentPage.selection[0] as RectangleNode).strokeWeight;
    figma.ui.postMessage({ "strokeWeight": rectangleSelectionStroke });
    var rectangleSelectionX = (figma.currentPage.selection[0] as RectangleNode).x;
    figma.ui.postMessage({ "x": rectangleSelectionX });
    var rectangleSelectionY = (figma.currentPage.selection[0] as RectangleNode).y;
    figma.ui.postMessage({ "y": rectangleSelectionY });
  }
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'ELLIPSE') {
    ...
    var ellipseSelectionStroke = (figma.currentPage.selection[0] as EllipseNode).strokeWeight;
    ...
    //   var frameSelectionPT = (figma.currentPage.selection[0] as FrameNode).paddingTop;
    //   figma.ui.postMessage({ "paddingTop": frameSelectionPT });
    //   var frameSelectionPB = (figma.currentPage.selection[0] as FrameNode).paddingBottom;
    //   figma.ui.postMessage({ "paddingBottom": frameSelectionPB });
    // }
  ...
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'INSTANCE') {
    ...
    var instanceSelectionRadius = (figma.currentPage.selection[0] as InstanceNode).cornerRadius;
    figma.ui.postMessage({ "cornerRadius": instanceSelectionRadius });
    var instanceSelectionStroke = (figma.currentPage.selection[0] as InstanceNode).strokeWeight;
  ...
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'COMPONENT' || 'COMPONENT_SET') {
    ...
    var componentSelectionRadius = (figma.currentPage.selection[0] as ComponentNode).cornerRadius;
    figma.ui.postMessage({ "cornerRadius": componentSelectionRadius });
    var componentSelectionStroke = (figma.currentPage.selection[0] as ComponentNode).strokeWeight;
    figma.ui.postMessage({ "strokeWeight": componentSelectionStroke });
    var componentSelectionX = (figma.currentPage.selection[0] as ComponentNode).x;
    figma.ui.postMessage({ "x": componentSelectionX });
    var componentSelectionY = (figma.currentPage.selection[0] as ComponentNode).y;
    figma.ui.postMessage({ "y": componentSelectionY });
  }
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'VECTOR') {
    ...
    var vectorSelectionStroke = (figma.currentPage.selection[0] as VectorNode).strokeWeight;
  ...
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'STAR') {
    ...
    var starSelectionRadius = (figma.currentPage.selection[0] as StarNode).cornerRadius;
    figma.ui.postMessage({ "cornerRadius": starSelectionRadius });
    var starSelectionStroke = (figma.currentPage.selection[0] as StarNode).strokeWeight;
  ...
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'LINE') {
    ...
    var lineSelectionStroke = (figma.currentPage.selection[0] as LineNode).strokeWeight;
  ...
  else if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'POLYGON') {
    ...
    var polygonSelectionRadius = (figma.currentPage.selection[0] as PolygonNode).cornerRadius;
    figma.ui.postMessage({ "cornerRadius": polygonSelectionRadius });
    var polygonSelectionStroke = (figma.currentPage.selection[0] as PolygonNode).strokeWeight;
