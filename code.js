...
function makeSelection() {
    if (figma.currentPage.selection.length > 0 && figma.currentPage.selection[0].type === 'TEXT') {
        ...
        var textSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        ...
        var rectSelectionRadius = figma.currentPage.selection[0].cornerRadius;
        figma.ui.postMessage({ "cornerRadius": rectSelectionRadius });
        var rectangleSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        figma.ui.postMessage({ "strokeWeight": rectangleSelectionStroke });
        var rectangleSelectionX = figma.currentPage.selection[0].x;
        figma.ui.postMessage({ "x": rectangleSelectionX });
        var rectangleSelectionY = figma.currentPage.selection[0].y;
        ...
        var ellipseSelectionArcStart = figma.currentPage.selection[0].arcData.startingAngle;
        figma.ui.postMessage({ "startingAngle": ellipseSelectionArcStart });
        var ellipseSelectionArcEnd = figma.currentPage.selection[0].arcData.endingAngle;
        figma.ui.postMessage({ "endingAngle": ellipseSelectionArcEnd });
        var ellipseSelectionArcInnerRadius = figma.currentPage.selection[0].arcData.innerRadius;
        figma.ui.postMessage({ "innerRadius": ellipseSelectionArcInnerRadius });
        var ellipseSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        ...
        var instanceSelectionRadius = figma.currentPage.selection[0].cornerRadius;
        figma.ui.postMessage({ "cornerRadius": instanceSelectionRadius });
        var instanceSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        ...
        var componentSelectionRadius = figma.currentPage.selection[0].cornerRadius;
        figma.ui.postMessage({ "cornerRadius": componentSelectionRadius });
        var componentSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        figma.ui.postMessage({ "strokeWeight": componentSelectionStroke });
        var componentSelectionX = figma.currentPage.selection[0].x;
        figma.ui.postMessage({ "x": componentSelectionX });
        var componentSelectionY = figma.currentPage.selection[0].y;
        ...
        var vectorSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        ...
        var starSelectionRadius = figma.currentPage.selection[0].cornerRadius;
        figma.ui.postMessage({ "cornerRadius": starSelectionRadius });
        var starSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        ...
        var lineSelectionStroke = figma.currentPage.selection[0].strokeWeight;
        ...
        var polygonSelectionRadius = figma.currentPage.selection[0].cornerRadius;
        figma.ui.postMessage({ "cornerRadius": polygonSelectionRadius });
        var polygonSelectionStroke = figma.currentPage.selection[0].strokeWeight;
